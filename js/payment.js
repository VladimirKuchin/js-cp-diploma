...
startSeance.textContent = `${parsedSeances.seanceTime}, ${orderedDay}`;
...
document.querySelector('.acceptin-button').addEventListener('click', () => {
  fetch('https://jscp-diplom.netoserver.ru/', {
    method: 'POST',
    body: `event=sale_add&timestamp=${parsedSeances.timeStamp}&hallId=${parsedSeances.hallId}&seanceId=${parsedSeances.seanceId}&hallConfiguration=${parsedSeances.hallConfig}`,
    headers: {
